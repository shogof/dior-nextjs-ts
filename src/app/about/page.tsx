    ...
    return (
      <div className="bg-gray-100 text-gray-800 min-h-screen flex flex-col">
        <div className="flex flex-col items-center justify-center flex-grow p-8 pt-24">
          ...
          <p className="text-lg text-gray-700 mb-6 text-justify max-w-2xl">
            The brand's revolutionary "New Look" silhouette in 1947 transformed
            women's fashion and redefined femininity. Today, Dior continues to be
            a leader in luxury fashion, blending tradition with modernity.
          </p>
